...
# ============================================================================
# PUSH NOTIFICATIONS - Appointment Events (OBSOLETE: Moved to notifications.signals)
# ============================================================================

# As notificações agora são centralizadas em notifications/signals.py
# para evitar redundância e garantir consistência entre canais (SMS, Push, In-App).
