...
class CreditWebhookTestCase(TestCase):
    ...
    def test_payment_intent_succeeded_webhook(self, mock_construct_event):
        ...
        webhook_event = StripeWebhookEvent.objects.get(stripe_event_id='evt_test_webhook')
    ...
    def test_duplicate_webhook_processing(self, mock_construct_event):
        ...
        self.tenant.refresh_from_db()
        self.assertEqual(self.tenant.comm_credit_eur, Decimal('10.00'))  # Ainda 10, não 20
    ...
    def test_webhook_payment_not_found(self, mock_construct_event):
        ...
        webhook_event = StripeWebhookEvent.objects.get(stripe_event_id='evt_test_not_found')
