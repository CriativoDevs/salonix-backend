...
class CommunicationCreditService:
    ...
    def get_cost(self, communication_type: str, message_category: str = None) -> Decimal:
        """
    ...
    def can_send_message(self, tenant: Tenant, communication_type: str, 
                        message_category: str = 'utility') -> Dict[str, any]:
        """
        ...
        if current_balance >= cost:
            ...
            result['reason'] = f'Saldo insuficiente. Necessário: €{cost}, Disponível: €{current_balance}'
        
        return result
    
    @transaction.atomic
    def charge_for_message(self, tenant: Tenant, communication_type: str, 
        ...
        check_result = self.can_send_message(tenant, communication_type, message_category)
        ...
        ledger_entry = CommLedger.objects.create(
            ...
            description=description or f"Envio de {communication_type} - {message_category}",
            created_by=user
        )
    ...
    def get_recent_transactions(self, tenant: Tenant, limit: int = 10) -> list:
        ...
        """
        return list(
            CommLedger.objects.filter(tenant=tenant)
