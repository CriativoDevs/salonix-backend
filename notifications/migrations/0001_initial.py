    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(help_text="Título da notificação", max_length=255),
                ),
                ("message", models.TextField(help_text="Conteúdo da notificação")),
                (
                    "is_read",
                    models.BooleanField(
                        default=False, help_text="Se a notificação foi lida"
                    ),
                ),
                (
                    "metadata",
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="Quando a notificação foi lida", null=True
                    ),
                ),
                (
                    "tenant",
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        ...
                        name="notificatio_tenant__127235_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "device_type",
                    models.CharField(
                        choices=[("web", "Web Push"), ("mobile", "Mobile Push (Expo)")],
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["tenant", "user", "device_type"],
                        name="notificatio_tenant__67e5c0_idx",
                    ),
                    models.Index(
                        fields=["tenant", "is_active"],
                        name="notificatio_tenant__9ec41b_idx",
                    ),
                ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Canal de envio da notificação",
                        max_length=15,
                    ),
                ),
                (
                    "notification_type",
                    models.CharField(
                        help_text="Tipo da notificação (mesmo do Notification)",
                        max_length=30,
                    ),
                ),
                (
                    "title",
                    models.CharField(
                        help_text="Título da notificação enviada", max_length=255
                    ),
                ),
                (
                    "message",
                    models.TextField(help_text="Conteúdo da notificação enviada"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "sent_at",
                    models.DateTimeField(
                        blank=True, help_text="Quando foi enviado", null=True
                    ),
                ),
                (
                    "delivered_at",
                    models.DateTimeField(
                        blank=True,
                        help_text="Quando foi entregue (se disponível)",
                        null=True,
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant", "channel", "-created_at"],
                        name="notificatio_tenant__11af92_idx",
                    ),
                    models.Index(
                        fields=["tenant", "user", "-created_at"],
                        name="notificatio_tenant__b45a6f_idx",
                    ),
                    models.Index(
                        fields=["tenant", "status", "channel"],
                        name="notificatio_tenant__45713a_idx",
                    ),
                    models.Index(
