...
class CommunicationCreditServiceTest(TestCase):
    ...
    def test_can_send_message_sufficient_balance(self):
        ...
        self.assertEqual(result['cost'], Decimal('0.05'))  # Ajustado para 2 casas decimais
    ...
    def test_charge_for_message_success(self):
        ...
        self.assertEqual(ledger_entry.transaction_type, CommLedger.TransactionType.CONSUMPTION)
        self.assertEqual(ledger_entry.amount_eur, Decimal('0.05'))  # Ajustado para 2 casas decimais
    ...
    def test_get_recent_transactions(self):
        ...
        for transaction in transactions:
            ...
            self.assertEqual(transaction.transaction_type, CommLedger.TransactionType.CONSUMPTION)